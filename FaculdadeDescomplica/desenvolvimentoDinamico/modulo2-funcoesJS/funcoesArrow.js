...
// Eemplo de arrow function com um único parâmetro (não precisa de parênteses)
let dobrar = n => n*2;

// Chamando a função e exibindo o resultado no console
console.log(dobrar(5));

// Exemplo de uma arrow funcition usada como callback
...
// Arrow function com corpo de funçaõ mais complexo
